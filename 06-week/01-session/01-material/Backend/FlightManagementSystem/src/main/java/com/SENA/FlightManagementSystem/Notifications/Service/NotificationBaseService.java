...
public abstract class NotificationBaseService<T extends ANotificationBaseEntity, DReq, DRes> implements INotificationBaseService<T, DReq, DRes> {
     ...
     */
    protected abstract INotificationBaseRepository<T, String> getRepository();
