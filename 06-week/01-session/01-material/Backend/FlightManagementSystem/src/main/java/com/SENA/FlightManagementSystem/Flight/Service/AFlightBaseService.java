...
/**
 * Abstract base service providing common CRUD operations for Flight entities.
 *
 ...
 */
abstract public class AFlightBaseService<T extends AFlightBaseEntity, DReq, DRes> implements IFlightBaseService<T, DReq, DRes> {
