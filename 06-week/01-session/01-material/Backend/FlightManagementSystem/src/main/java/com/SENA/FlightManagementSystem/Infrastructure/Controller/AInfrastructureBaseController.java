 ...
 */
public abstract class AInfrastructureBaseController<T extends AInfrastructureBaseEntity, DReq, DRes, S extends IInfrastructureBaseService<T, DReq, DRes>> {

    protected S service;
    protected String entityName;

    protected AInfrastructureBaseController(S service, String entityName) {
