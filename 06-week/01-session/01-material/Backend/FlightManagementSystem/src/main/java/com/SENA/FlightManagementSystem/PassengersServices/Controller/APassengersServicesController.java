...
public abstract class APassengersServicesController<T extends APassengersServicesBaseEntity, DReq, DRes, S extends IPassengersServicesBaseService<T, DReq, DRes>> {


    protected S service;
    protected String entityName;

    protected APassengersServicesController(S service, String entityName) {
