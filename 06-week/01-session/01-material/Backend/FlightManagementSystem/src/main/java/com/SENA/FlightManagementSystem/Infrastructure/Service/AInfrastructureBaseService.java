 ...
 */
abstract public class AInfrastructureBaseService<T extends AInfrastructureBaseEntity, DReq, DRes> implements IInfrastructureBaseService<T, DReq, DRes> {

    protected abstract IInfrastructureBaseRepository<T, String> getRepository();
