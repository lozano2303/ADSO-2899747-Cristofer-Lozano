...
public abstract class APassengersServicesBaseService<T extends APassengersServicesBaseEntity, DReq, DRes> implements IPassengersServicesBaseService<T, DReq, DRes> {
