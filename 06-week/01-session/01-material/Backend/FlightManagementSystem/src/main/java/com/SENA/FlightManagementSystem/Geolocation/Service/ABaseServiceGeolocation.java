...
import com.SENA.FlightManagementSystem.Geolocation.Entity.ABaseEntityGeolocation;
...
abstract public class ABaseServiceGeolocation<T extends ABaseEntityGeo, DReq, DRes> implements IBaseServiceGeolocation<T, DReq, DRes> {
     ...
     */
    protected abstract IBaseRepositoryGeolocation<T, String> getRepository();
