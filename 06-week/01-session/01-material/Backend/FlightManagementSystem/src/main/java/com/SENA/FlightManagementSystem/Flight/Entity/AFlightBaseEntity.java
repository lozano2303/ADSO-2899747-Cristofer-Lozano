...
@MappedSuperclass
public abstract class AFlightBaseEntity {
    @Id
    @Column(name = "id", nullable = false, updatable = false, length = 36)
    @GeneratedValue(strategy = GenerationType.UUID)
    private String id;

    @Schema(description = "Código del dato", example = "FL001")
    ...
    @Schema(description = "Descripción del dato", example = "Vuelo comercial")
